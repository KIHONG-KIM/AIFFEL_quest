...
플러터 프로그램을 만들어보면서, 조금씩 실력이 늘어가는 것 같습니다.
레이아웃을 적용할 때 
라우팅을 할 때 아직 모르는 부분이 많이 있음을 확인하고 
onGenerateRoute부분을 더 자세히 알아봐야겠다고 생각했고,
더 적극적인 공부를 해야겠다고 생각했습니다.

특별히 커스텀 네비게이션 바를 만드려고했는데 결국 라우팅으로 해결했습니다.
짧은 시간에 조금 더 깔끔하고 보기 쉬운 코드를 작성하고, 
여러가지 구현을 빠르게 하기 위해서는 정말 제대로 알아야겠다는 생각이 드는 퀘스트 였습니다.
